...
public class MR4 {
    private static String inPath = "../../test/userCF/step2_output";

    private static String outPath = "../../test/userCF/step4_output";
    private static String cache = "../../test/userCF/step3_output/part-r-00000";
